		...
		<div class="content">
			...
			<table border="1px">
				...
				<tr>
					...
					<td class="tableTd"><?php echo "<a class='btn btn-primary' href= 'updateAudio.php?audio_id={$info['id']}'>Update</a>";?></td>
					<td class="tableTd"><?php echo "<a class='btn btn-danger' onClick=\" javascript:return confirm('Are you sure to delete this?');\" href= 'deleteAudio.php?audio_id={$info['id']}'>Delete</a>";?></td>
