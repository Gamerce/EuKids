...
<head>
    ...
    <link rel="stylesheet" href="../css_pages/style1.css">
	...
	<div class="navbar">
		<div class="navbar-container">
			...
			<div class="meny-container">
				<ul class="meny-list">
					<li class="meny-list-item"><a href="../php_pages/preview.php">PREVIEW</a></li>
					<li class="meny-list-item">HOME</li>
					<li class="meny-list-item">ABOUT</li>
					<li class="meny-list-item"> <a href="#contact">CONTACT</a></li>
					<li class="meny-list-item"><a href="../php_pages/register.php">REGISTER</a></li>
					<li class="meny-list-item"><a href="../php_pages\login.php">LOGIN</a></li>
					<li class="meny-list-item"><a href="../php_pages\login.php">ADMIN</a></li>
	...
	<div class="container">
		<div class="content-container">
					...
					<div class="game-list-wrapper">
						...
						<div class="game-list">
							<div class="game-list-item">
								...
								<span class="game-list-item-tittle">Game1</span>
							...
							<div class="game-list-item">
								<img class="game-list-item-img" alt="" src="../images/card2.png">
								<span class="game-list-item-tittle">Game2</span>
								<p class="game-list-item-desc">It is a unique experience where the player help the kitty though the story using </p>
								<button class="game-list-item-button">Play</button>
							</div>
							<div class="game-list-item">
								<img class="game-list-item-img" alt="" src="../images/card3.png">
								<span class="game-list-item-tittle">Game3</span>
								<p class="game-list-item-desc">It is a unique experience where the player help the kitty though the story </p>
								<button class="game-list-item-button">Play</button>
							</div>
							<div class="game-list-item">
								<img class="game-list-item-img" alt="" src="../images/card4.png">
								<span class="game-list-item-tittle">Game4</span>
							...
							<div class="game-list-item">
								<img class="game-list-item-img" alt="" src="../images/film2.png">
								<span class="game-list-item-tittle">Game5</span>
							...
							<div class="game-list-item">
								<img class="game-list-item-img" alt="" src="../images/film2.png">
								<span class="game-list-item-tittle">Game6</span>
			...
			>
				...
				<h2 class="featured-title" >Bear</h2>
				<p class="featured-description">	Blue eyed kitty is a creative game for the 3-12 year olds with a focus on storytelling.
					It is a unique experience where the player help the kitty though the story using the tablet or smartphone as a window into the game universe.
					The game is developed in close cooperation with Kongo Interactive.
					View more games and app projects we have worked with.</p>
					...
					<div class="game-list-wrapper">
						<div class="game-list video-list">
							<div class="game-list-item">						
								...
								<button class="game-list-item-button">Watch full video</button>
								</a>
							</div>
							<div class="game-list-item">
